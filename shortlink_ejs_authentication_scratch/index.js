...
//lets route for the signup page
const signup_model = require("./Routes/signup_route")
//lets route for the login page
const login_model = require("./Routes/login_route")
...
//lets set the route
app.use("/signup",signup_model)
app.use("/login",login_model)
